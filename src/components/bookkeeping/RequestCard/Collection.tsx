...
export function Collection({ formData, isSaving, isEditing, handleAddRow, handleDeleteRow, handleArrayChange, formatCurrency }: any) {
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <Label className="flex-1 text-base font-semibold">Collection</Label>
                <div className="w-[120px] text-xs text-muted-foreground font-medium">Amount Paid</div>
                {isEditing && (
                    <Button
                        type="button"
                        variant="outline"
